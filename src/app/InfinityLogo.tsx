...
const InfiniteLogos: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      logoNodes.forEach((logo) => {
        ...
        const distanceFromCenter = Math.abs(containerWidth / 2 - (logoOffsetLeft + logo.offsetWidth / 2));
  ...
  return (
   <section className="relative min-h-[200px] flex items-center overflow-hidden px-4 sm:px-6 lg:px-8">
  <div ref={containerRef} className="flex gap-6 absolute">
